...
makeTravisCoordsFromTxDb <- function(txdb, 
  ...
  mRNA_front_bin <- makeTravisCoordsFromGRangesList(side[["mrna_front"]],parameter$noBins)
  mRNA_back_bin <- makeTravisCoordsFromGRangesList(side[["mrna_back"]],parameter$noBins)
  ncRNA_front_bin <- makeTravisCoordsFromGRangesList(side[["ncrna_front"]],parameter$noBins)
  ncRNA_back_bin <- makeTravisCoordsFromGRangesList(side[["ncrna_back"]],parameter$noBins)
  ...
  mcols(ncRNA_back_bin)$pos <- mcols(ncRNA_back_bin)$pos + 2
  
  
  TravisCoords <- suppressWarnings(c(mRNA_front_bin,utr5_bin, cds_bin, utr3_bin, mRNA_back_bin,
